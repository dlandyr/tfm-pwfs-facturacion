# TFM - Plataforma de Facturación como Servicio - Microservicio de Facturacion
...
### Swagger
Se monta un cliente swagger para atacar al API: http://localhost:8082/api/v0/swagger-ui.html.
